...
HR@5:0.3653,NDCG@5:0.2454,HR@10:0.5264,NDCG@10:0.2974,HR@20:0.7237,NDCG@20:0.3472

python main.py --model_name MyModel --reg 1e-6 --temp 0.3 --dataset Grocery_and_Gourmet_Food --lr 0.0003 --emb_size 64 --hyper_num 8 --keepRate 1 --ssl_reg 0.3 --num_workers 0
HR@5:0.3451,NDCG@5:0.2376,HR@10:0.4547,NDCG@10:0.2732,HR@20:0.5726,NDCG@20:0.3029

LightGCN
python main.py --model_name LightGCN --dataset Grocery_and_Gourmet_Food
python main.py --model_name LightGCN --path ../data/MovieLens_1M --dataset ML_1MTOPK

BPRMF
python main.py --model_name BPRMF --emb_size 64 --lr 1e-3 --l2 1e-6 --dataset Grocery_and_Gourmet_Food
python main.py --model_name BPRMF --emb_size 64 --lr 1e-3 --l2 1e-6 --path ../data/MovieLens_1M --dataset ML_1MTOPK
'''
...
if __name__ == '__main__':
	...
	logging.basicConfig(filename='test', level=args.verbose)
